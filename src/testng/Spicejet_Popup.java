...
// enter name in popup window
driver.findElement(By.id("Nombre")).sendKeys("gghhggghhh");
...
driver.findElement(By.xpath("html/body/div[1]/div/div[2]/div[1]/div[3]/div[3]/a")).click();
